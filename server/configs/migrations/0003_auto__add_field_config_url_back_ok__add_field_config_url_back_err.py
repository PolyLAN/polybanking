...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Config.url_back_ok'
        db.add_column(u'configs_config', 'url_back_ok',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Config.url_back_err'
        db.add_column(u'configs_config', 'url_back_err',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Config.url_back_ok'
        db.delete_column(u'configs_config', 'url_back_ok')

        # Deleting field 'Config.url_back_err'
        db.delete_column(u'configs_config', 'url_back_err')
