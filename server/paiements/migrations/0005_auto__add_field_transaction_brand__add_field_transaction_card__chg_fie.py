...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.brand'
        db.add_column(u'paiements_transaction', 'brand',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Adding field 'Transaction.card'
        db.add_column(u'paiements_transaction', 'card',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


        # Changing field 'TransactionLog.when'
        db.alter_column(u'paiements_transactionlog', 'when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Transaction.brand'
        db.delete_column(u'paiements_transaction', 'brand')

        # Deleting field 'Transaction.card'
        db.delete_column(u'paiements_transaction', 'card')


        # Changing field 'TransactionLog.when'
        db.alter_column(u'paiements_transactionlog', 'when', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'paiements.transaction': {
            ...
            'brand': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128'}),
            'card': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128'}),
