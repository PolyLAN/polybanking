...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'paiements_transaction', (
            ...
            ('postfinance_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('postfinance_status', self.gf('django.db.models.fields.CharField')(default='??', max_length=2)),
            ('internal_status', self.gf('django.db.models.fields.CharField')(default='cr', max_length=2)),
            ('ipn_needed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_userforwarded_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('last_user_back_from_postfinance_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('last_postfinance_ipn_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('last_ipn_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'paiements', ['Transaction'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'paiements_transaction')
